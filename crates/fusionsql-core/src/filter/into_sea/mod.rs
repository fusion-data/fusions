...
pub type ToSeaConditionFn = fn(col: &ColumnRef, op_value: OpValValue) -> SeaResult<Vec<ConditionExpression>>;
...
impl ToSeaConditionFnHolder {
  ...
  pub fn call(&self, col: &ColumnRef, op_value: OpValValue) -> SeaResult<Vec<ConditionExpression>> {
