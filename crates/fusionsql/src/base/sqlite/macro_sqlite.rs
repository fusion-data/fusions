	...
	(
		...
		impl $struct_name {
			...
			where
				C: fusionsql::ModelContext,
			{
				fusionsql::base::sqlite_find_by_id::<C, Self, _>(mm, id.into()).await
			}
			...
			where
				C: fusionsql::ModelContext,
			{
				fusionsql::base::sqlite_get_by_id::<C, Self, _>(mm, id.into()).await
			}
	...
	(
		...
		impl $struct_name {
			...
			where
				C: fusionsql::ModelContext,
			{
				fusionsql::base::sqlite_find_unique::<C, Self, _, _>(mm, filter).await
			}
			...
			where
				C: fusionsql::ModelContext,
			{
				fusionsql::base::sqlite_find_many::<C, Self, _, _>(mm, filter, page).await
			}
			...
			where
				C: fusionsql::ModelContext,
			{
				fusionsql::base::sqlite_page::<C, Self, _, _>(mm, filter, page).await
			}
  ...
  (
    ...
    impl $struct_name {
      ...
      where
        C: fusionsql::ModelContext,
      {
        fusionsql::base::sqlite_get_filter::<C, Self, _, _>(mm, filter).await
      }
    }
  };
}
