...
impl SentimentAnalysisTask {
  ...
  async fn dummy_sentiment(&self, context: Context, user_input: String) -> fusions::ai::graph_flow::Result<TaskResult> {
...
impl Task for PositiveResponseTask {
  async fn run(&self, _context: Context) -> fusions::ai::graph_flow::Result<TaskResult> {
